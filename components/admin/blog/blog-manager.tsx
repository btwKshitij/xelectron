  ...
  return (
    <div className="mx-auto max-w-[1400px] space-y-5">
      <header className="flex flex-wrap items-center justify-between gap-3">
        ...
        <Link prefetch={false} href="/dashboard/blog/new" className="inline-flex h-9 items-center gap-1.5 rounded-lg bg-black px-3.5 text-xs font-semibold text-white transition hover:bg-black/80"><Plus className="size-3.5" />Add new blog post</Link>
      </header>
